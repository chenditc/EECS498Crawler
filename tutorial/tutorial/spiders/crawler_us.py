...
class MininovaSpider(CrawlSpider):
    ...
    start_urls = ['https://www.answers.yahoo.com/?tab=recent&filter=intl']
    rules = [Rule(SgmlLinkExtractor(allow=(r"(.*www\.answers\.yahoo\.com/question/index\?qid=\w*$)|(.*www.answers.yahoo.com/?tab=recent&filter=intl&page=.*)")), 'parse_question', follow=True)]
